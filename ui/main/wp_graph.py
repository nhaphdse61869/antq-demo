...
class AntQTab(QWidget):
    ...
    def __init__(self):
        ...
        self.learning_rate_spin.setMaximum(101)
        ...
        self.discount_factor_spin.setMaximum(101)
        ...
        self.balance_rate_spin.setMaximum(101)
        ...
        self.iteration_spin.setMaximum(1000000)
        ...
        self.k_num_spin.setMaximum(1001)
...
class ACOTab(QWidget):
    ...
    def __init__(self):
        ...
        self.alpha_spin.setMinimum(0)
        self.alpha_spin.setMaximum(101)
        self.alpha_spin.setValue(1)
        self.form_layout1.addRow(QLabel("α:"), self.alpha_spin)
        self.beta_spin = QSpinBox()
        self.beta_spin.setMinimum(0)
        self.beta_spin.setMaximum(101)
        self.beta_spin.setValue(2)
        ...
        self.form_container2 = QGroupBox("Residual Coefficient")
        self.form_layout2 = QFormLayout()
        self.residual_coefficient_spin = QSpinBox()
        self.residual_coefficient_spin.setMinimum(0)
        self.residual_coefficient_spin.setMaximum(100)
        self.residual_coefficient_spin.setValue(60)
        self.form_layout2.addRow(QLabel("Rho:"), self.residual_coefficient_spin)
        self.form_container2.setLayout(self.form_layout2)

        self.form_container3 = QGroupBox("Intensity")
        self.form_layout3 = QFormLayout()
        self.intensity_spin = QSpinBox()
        self.intensity_spin.setMinimum(0)
        self.intensity_spin.setMaximum(101)
        self.intensity_spin.setValue(90)
        self.form_layout3.addRow(QLabel("Q:"), self.intensity_spin)
        self.form_container3.setLayout(self.form_layout3)

        self.form_container4 = QGroupBox("Iteration")
        self.form_layout4 = QFormLayout()
        self.iteration_spin = QSpinBox()
        self.iteration_spin.setMinimum(0)
        self.iteration_spin.setMaximum(1000000)
        self.iteration_spin.setValue(1000)
        self.form_layout4.addRow(QLabel("Iter:"), self.iteration_spin)
        self.form_container4.setLayout(self.form_layout4)
        ...
        self.right_bottom_layout.addWidget(self.form_container3)
...
class SimAnnealTab(QWidget):
    ...
    def __init__(self):
        ...
        self.temper_init_spin.setMaximum(1000000)
        self.temper_init_spin.setValue(100)
        self.temper_end_spin = QSpinBox()
        self.temper_end_spin.setMaximum(1000000)
        self.temper_end_spin.setValue(0)
